...
MODIFICATIONS = [
    #Pre -Steps:
    {
        ...
        "operations": [
            {
                "type": "replace_line",
                "description": "Modify Godot title to add custom name",
    ...
    
    {
        ...
        "operations": [
            {
                "type": "replace_line",
                "description": "Modify Godot export popup title to add custom name",
                "find": "set_title(TTRC(\"Export\"));",
                "replace": f"set_title(TTRC(\"Export With {customName} (AES-256)\"));",
            }
        ]
    },
